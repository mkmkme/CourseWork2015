...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "coursework2015" because\n';
  ...
  $wnd.__gwt_activeModules['coursework2015'] = {
    'moduleName' : 'coursework2015',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/coursework2015.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['coursework2015'].superdevmode = true;

  var expectedSuffix = '/coursework2015.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + coursework2015 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:coursework2015';
  var devModeSessionKey = '__gwtDevModeSession:coursework2015';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/coursework2015/coursework2015.nocache.js';
  ...
  $wnd.__gwt_activeModules['coursework2015'].canRedirect = true;
  $wnd.__gwt_activeModules['coursework2015'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING coursework2015';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/coursework2015?user.agent=' + ua + '&_callback=' + callback;
